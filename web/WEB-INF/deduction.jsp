...
<head>
    ...
    <link rel="stylesheet" href="css/style_dep.css">
    <script>
        function get() {
        ...
        <div class="wrapper typo">Отображение
            <div class="list"><span class="placeholder">выберите</span>
                <ul class="list__ul">
                    ...
                    <li><a id="dr" class="selecter" href="">по собственному желанию</a></li>
                    <li><a id="bl" class="selecter" href="">по академической неуспеваемости</a></li>
                </ul>
            </div>
        </div>
