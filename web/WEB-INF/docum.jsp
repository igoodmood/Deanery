...
<head>
    ...
    <link rel="stylesheet" href="css/style_docum.css">
...
<div class="container-contact100">
    <div class="wrap-contact100">
        <form class="contact100-form validate-form">
            <span class="contact100-form-title">Документы</span>
            <h4 class="inftitle">На данной странице предоставлены различные документы.</h4>
            <div class="documen">${docs}</div>
        </form>
    </div>
</div>
